...
// @desc    Get all tasks (Admin: all , User: assigned to them)
// @route   GET /api/tasks
// @access  Private
...
const getTasks = async (req, res) => {
    try {
        ...
        //Add cpmpleted todoCheckList count to each task
    ...
    ...filter,
    status: "In-Progress", // Make sure this matches your DB status string exactly!
    ...(req.user.role !== "admin" && { assignedTo: req.user._id }),
});
...
// @desc    Get task by ID (Admin: all , User: assigned to them)
...
// @access  Private
 const updateTaskCheckList = async (req, res) => {
    try {
        ...
        // Fixed Schema compatibility check
        const isAssigned = task.assignedTo && task.assignedTo.toString() === req.user._id.toString();
