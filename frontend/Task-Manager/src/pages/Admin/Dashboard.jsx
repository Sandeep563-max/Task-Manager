...
const Dashboard = () => {
  ...
  const user = savedData ? JSON.parse(savedData) : { name: 'Admin' };

  // MOCK DATA: 
  const stats = [
    { label: "Total Tasks", count: 18, color: "bg-blue-600" },
    { label: "Pending Tasks", count: 11, color: "bg-purple-500" },
    { label: "In Progress", count: 5, color: "bg-cyan-500" },
    { label: "Completed Tasks", count: 2, color: "bg-green-500" }
  ];
  ...
  const barData = [
    ...
    { name: 'Medium', count: 6, color: '#f59e0b' },
    { name: 'High', count: 7, color: '#ef4444' },
  ];
  ...
  const recentTasks = [
    ...
    { id: 3, name: "Implement Notification System", status: "Pending", priority: "Low", date: "17th Mar 2025" },
    { id: 4, name: "Migrate Database to MongoDB Atlas", status: "Completed", priority: "Medium", date: "17th Mar 2025" },
    { id: 5, name: "Develop Expense Tracker Module", status: "Pending", priority: "Low", date: "17th Mar 2025" },
    { id: 6, name: "Design Homepage Banner", status: "Pending", priority: "Medium", date: "17th Mar 2025" }
  ];
    ...
    <AdminLayout>
      <div className="p-8 bg-gray-50 min-h-screen">
        ...
        <div className="bg-white rounded-xl shadow-sm p-6 mb-6">
          ...
          <p className="text-sm text-gray-500 mb-6">Tuesday 25th Mar 2025</p>
                  ...
                  <tr key={task.id} className="border-b last:border-b-0 hover:bg-gray-50">
                    ...
                    <td className="py-4 text-center">
                      <span className={`px-3 py-1 rounded-md text-xs font-medium
                        ${task.status === 'Completed' ? 'bg-green-100 text-green-700' : 'bg-purple-100 text-purple-700'}
                      `}>
                        {task.status}
                      </span>
                    </td>
